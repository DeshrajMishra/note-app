        ...
        return (
            `<div class="single-note relative shadow">
                ...
                <div class="options d-flex gap-md">
                    <button class="button btn del-btn v-hidden" data-type="pinned" data-id=${id}>
                        <span data-id=${id} data-type="pinned" class=${isPinned ? "material-icons" : "material-icons-outlined"}>push_pin</span>
                    </button>
                    <button class="button btn del-btn v-hidden" data-type="archive" data-id=${id}>
